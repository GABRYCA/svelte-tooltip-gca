<script lang="ts">
	...
	// Code samples live here so Svelte does not parse tags inside markup.
  ...
  Hover me
	...
	// Split closing script tag so the HTML parser does not end this block early.
	const codeMinimal =
		`<script>\n` +
	...
	<main>
		<section class="hero">
			...
			<div class="hero-demo">
				...
				<button class="chip accent" use:tooltip={{ content: 'Brand gradient theme', theme: brandTheme, placement: 'top' }}>
					Custom theme
				</button>
			</div>
		</section>
			...
			<div class="grid">
				...
				<article class="card demo-card">
					...
					<div class="demo-row wrap">
						...
						<button class="btn secondary" use:tooltip={{ content: 'Bottom', placement: 'bottom' }}>Bottom</button>
						<button class="btn secondary" use:tooltip={{ content: 'Left', placement: 'left' }}>Left</button>
						<button class="btn secondary" use:tooltip={{ content: 'Right', placement: 'right' }}>Right</button>
					</div>
				</article>
				...
				<article class="card demo-card">
					<h3>Overflow-safe</h3>
					<p>Portaled to <code>body</code> with high z-index — never clipped.</p>
					<div class="clip-box">
						<button
							class="btn secondary"
							use:tooltip={{
								content: 'I escape overflow: hidden containers',
								placement: 'top'
							}}
						>
			...
			<div class="card" style="margin-top: 1rem;">
				...
				<div class="table-wrap">
					<table>
						...
						<tbody>
							<tr><td><code>background</code></td><td>string</td><td>Panel background (color or gradient)</td></tr>
							<tr><td><code>color</code></td><td>string</td><td>Text color</td></tr>
							<tr><td><code>border</code></td><td>string</td><td>Border color</td></tr>
							<tr><td><code>shadow</code></td><td>string</td><td>CSS box-shadow</td></tr>
							<tr><td><code>borderRadius</code></td><td>string</td><td>Corner radius</td></tr>
							<tr><td><code>fontSize</code></td><td>string</td><td>Font size</td></tr>
							<tr><td><code>fontFamily</code></td><td>string</td><td>Font stack</td></tr>
							<tr><td><code>fontWeight</code></td><td>string</td><td>Font weight</td></tr>
							<tr><td><code>padding</code></td><td>string</td><td>Inner padding</td></tr>
							<tr><td><code>maxWidth</code></td><td>string</td><td>Max width</td></tr>
							<tr><td><code>arrowSize</code></td><td>string | number</td><td>Arrow size</td></tr>
							<tr><td><code>zIndex</code></td><td>number | string</td><td>Stacking order (default 9999)</td></tr>
						</tbody>
					</table>
				</div>
			</div>
		...
		<section class="section features">
			...
			<div class="feature-grid">
				...
				<div class="feature">
					<span class="feature-icon">🚀</span>
					<h3>Never clipped</h3>
					<p>Renders in a portal on <code>document.body</code> with a high z-index.</p>
				</div>
			</div>
		</section>
	</main>
